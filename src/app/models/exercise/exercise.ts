...
export class Exercise {
  ...
  constructor(
    ...
    this.exerciseDescribtion = exerciseDescribtion;
    this.targetedMuscles = targetedMuscles;
    this.trackProgress = trackProgress;
    this.exerciseCategory = exerciseCategory ? exerciseCategory : '';
    this.exerciseCategoryCustom = exerciseCategoryCustom ? exerciseCategoryCustom : '';
  ...
  toObject() : Record <string, any>{
    ...
    Object.keys(this).forEach(key =>{
      if(key === 'trackingOptions'){
        ...
        obj[key] = this.targetedMuscles.toObject();
      }else{
